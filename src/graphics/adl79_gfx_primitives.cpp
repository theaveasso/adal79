...
void draw_circle_rgba(SDL_Renderer* p_renderer, const vec2f& p_pos, float p_rad, const adl_Color& p_color)
{
	...
	SDL_RenderGeometry(p_renderer, nullptr, vertices, num_segments + 2, indices, num_segments * 3);
